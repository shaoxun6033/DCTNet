...
parser = argparse.ArgumentParser(description='DCTNet for Time Series Forecasting')
...
parser.add_argument('--model', type=str, required=False, default='DCTNet',
                    help='model name, options: [Autoformer, DLinear, DCTNet]')
...
parser.add_argument('--stride', type=int, default=8, help='patch length for patch-based models')
